...
def arg_parse():
    ...
    # Contrastive arguments for contrastive method
...
def init_logger(args):
    ...
    log_file = os.path.join(log_path, "FMoE_DCSR_" + model_id + ".log")
...
def main():
    ...
    clients = [Client(ModelTrainer, c_id, args, adjs[c_id],
                      ...
                      test_datasets[c_id], n_clients) for c_id in range(n_clients)]
